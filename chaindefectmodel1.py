...
if __name__ == "__main__":
    ...
    with open("Outputmodel1.xyz", "w") as Pointer, open("Fractionmodel1.txt", "w") as Pointer1, open("AutoCorrelationmodel1.txt", "w") as Pointer2, open("EnergyIteration1.txt","w")as Pointer3:
